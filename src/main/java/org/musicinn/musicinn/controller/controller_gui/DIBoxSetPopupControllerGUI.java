...
import org.musicinn.musicinn.util.technical_rider_bean.DIBoxSetBean;
import java.net.URL;
import java.util.ResourceBundle;

public class DIBoxSetPopupControllerGUI implements Initializable {
    @FXML
    ...
    private DIBoxSetBean createdDIBoxSet;
    ...
    public DIBoxSetBean getCreatedDIBoxSet() {
        return createdDIBoxSet;
    }
}
